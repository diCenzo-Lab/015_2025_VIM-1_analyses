...
awk '{if(NR%4==1){gsub(/\//,"_")}; print}' "${4}/racon_polishing/combined_illumina.fastq" > "${4}/racon_polishing/test.fastq"
mv "${4}/racon_polishing/test.fastq" "${4}/racon_polishing/combined_illumina.fastq"
...
pigz -r -p $5 "${4}/racon_correction"
pigz -r -p $5 "${4}/medaka_correction"
pigz -r -p $5 "${4}/pilon_polishing"
pigz -r -p $5 "${4}/racon_polishing"
